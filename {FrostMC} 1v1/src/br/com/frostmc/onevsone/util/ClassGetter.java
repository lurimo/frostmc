...
public class ClassGetter {
	...
	public static void loadCommandBukkit() {
		for (Class<?> classes : ClassGetter.getClassesForPackage(Frost1v1.getPlugin(Frost1v1.class), "br.com.frostmc.onevsone.commands")) {
			try {
	...
	public static void loadListenerBukkit() {
		for (Class<?> classes : ClassGetter.getClassesForPackage(Frost1v1.getPlugin(Frost1v1.class), "br.com.frostmc.onevsone")) {
			try {
				if (Listener.class.isAssignableFrom(classes)) {
					Listener listener = (Listener) classes.newInstance();
					Bukkit.getPluginManager().registerEvents(listener, Frost1v1.getPlugin(Frost1v1.class));
				}
			} catch (Exception e) {
			}
		}
