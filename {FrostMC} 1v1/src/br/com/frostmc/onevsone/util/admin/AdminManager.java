package br.com.frostmc.onevsone.util.admin;
...
public class AdminManager {
	...
	public static void setAdmin(Player player) {
		...
		player.getInventory().setItem(0, new ItemBuilder().setNome("§3Informações - §7Clique no jogador").setMaterial(Material.NAME_TAG).finalizar());
