	...
	public boolean execute(CommandSender commandSender, String label, String[] args) {
		if (isPlayer(commandSender)) {
			...
			if (args.length == 1) {
				...
				if (targeton == null) {
					player.sendMessage("§8[§c§lINVSEE§8] §fEste jogador não foi encontrado no servidor.");
					return true;
				}
				...
				player.sendMessage("§8[§c§lINVSEE§8] §fVocê abriu o inventario do jogador " + player.getName());
				return true;
			}
		} else {
			return true;
