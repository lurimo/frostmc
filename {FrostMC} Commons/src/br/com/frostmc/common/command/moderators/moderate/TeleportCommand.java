		...
		if (isPlayer(commandSender)) {
			...
			if (args.length == 1) {
				if (args[0].equalsIgnoreCase("global") || args[0].equalsIgnoreCase("all")) {
					...
					player.sendMessage("§8[§a§lTELEPORT§8] §fVocê §e§lTELEPORTOU §ftodos os jogadores para sua localização.");
					return true;
				} else {
					if (Bukkit.getPlayer(args[0]) != null) {
						...
						player.sendMessage("§8[§a§lTELEPORT§8] §fVocê foi teleportado para o jogador §e" + player2.getName() + "§f.");
					} else {
				...
				if (Bukkit.getPlayer(args[0]) != null) {
					if (Bukkit.getPlayer(args[1]) != null) {
						...
						player.sendMessage("§8[§a§lTELEPORT§8] §fVocê teleportou o jogador §e" + player1.getName() + "§f para o jogador §e" + player2.getName() + "§f");
					} else {
						sendOfflinePlayerMessage(commandSender, args[0]);
						return false;
					}
				...
				player.sendMessage("§8[§a§lTELEPORT§8] §fVocê foi teleportado para X:§e" + args[0] + " §fY:§e" + args[1] + "§f Z:§e" + args[2]);
