...
public class AdminManager {
	...
	public static void setAdmin(Player player) {
		...
		player.sendMessage("§8[§c§lADMIN§8] §fVocê entrou no modo admin.");
		player.sendMessage("§8[§c§lADMIN§8] §fAgora você está invisível para " + getInvisible(player) + "");
	...
	public static void setPlayer(Player player) {
		...
		if (player.isOnline()) {
			...
			player.sendMessage("§8[§c§lADMIN§8] §fAgoda você está visível para §7§lMEMBROS");
		}
