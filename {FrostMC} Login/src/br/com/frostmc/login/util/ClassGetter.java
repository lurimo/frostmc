...
public class ClassGetter {
	...
	public static void loadCommandBukkit() {
		for (Class<?> classes : ClassGetter.getClassesForPackage(FrostLogin.getPlugin(FrostLogin.class), "br.com.frostmc.login.commands")) {
			try {
	...
	public static void loadListenerBukkit() {
		for (Class<?> classes : ClassGetter.getClassesForPackage(FrostLogin.getPlugin(FrostLogin.class), "br.com.frostmc.login")) {
			try {
				if (Listener.class.isAssignableFrom(classes)) {
					Listener listener = (Listener) classes.newInstance();
					Bukkit.getPluginManager().registerEvents(listener, FrostLogin.getPlugin(FrostLogin.class));
				}
			} catch (Exception exception) {
			}
		}
