...
public class ClassGetter {
	...
	public static void loadCommandBukkit() {
		for (Class<?> classes : getClassesForPackage(FrostGladiator.getPlugin(FrostGladiator.class), "br.com.frostmc.gladiator.commands")) {
			try {
	...
	public static void loadListenerBukkit() {
		for (Class<?> classes : getClassesForPackage(FrostGladiator.getPlugin(FrostGladiator.class), "br.com.frostmc.gladiator")) {
			try {
				if (Listener.class.isAssignableFrom(classes)) {
					Listener listener = (Listener) classes.newInstance();
					Bukkit.getPluginManager().registerEvents(listener, FrostGladiator.getPlugin(FrostGladiator.class));
				}
			} catch (Exception exception) {
			}
		}
