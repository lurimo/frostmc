...
public static String titleSeusKits;
	...
	public static void abrirMenu(Player p) {
		...
		inv.setItem(4, new ItemBuilder().setMaterial(Material.NETHER_STAR).setNome("§9Informação:").setLore(Arrays.asList("", "§fEscolha uma habilidade para", "§fjogar o pvpzão.")).finalizar());
