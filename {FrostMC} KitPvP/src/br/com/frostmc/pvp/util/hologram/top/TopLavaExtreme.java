...
public class TopLavaExtreme {
	...
	public void load() {
		try {
			...
			ResultSet resultSet = statement.executeQuery("SELECT * FROM `players_stats_pvp` ORDER BY `lava_extreme` DESC;");
			int x = 0;
	...
	public double x = -1002;
	public double y = 74;
	public double z = -1012;
	...
	public void spawnHologram(Location loc) {
		...
		if (nickname.size() == 0) {
			...
			one = "§71. " + nickname.get(0) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(0));
			two = "§72. §f-";
			tree = "§73. §f-";
			four = "§74. §f-";
			five = "§75. §f-";
			...
			one = "§71. " + nickname.get(0) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(0));
			two = "§72. " + nickname.get(1) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(1));
			tree = "§73. §f-";
			four = "§74. §f-";
			five = "§75. §f-";
			six = "§76. §f-";
			...
			one = "§71. " + nickname.get(0) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(0));
			two = "§72. " + nickname.get(1) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(1));
			tree = "§73. " + nickname.get(2) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(2));
			four = "§74. §f-";
			five = "§75. §f-";
			six = "§76. §f-";
			seven = "§77. §f-";
			...
			two = "§72. " + nickname.get(1) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(1));
			tree = "§73. " + nickname.get(2) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(2));
			four = "§74. " + nickname.get(3) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(3));
			five = "§75. §f-";
			six = "§76. §f-";
			seven = "§77. §f-";
			eight = "§78. §f-";
			...
			tree = "§73. " + nickname.get(2) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(2));
			four = "§74. " + nickname.get(3) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(3));
			five = "§75. " + nickname.get(4) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(4));
			six = "§76. §f-";
			seven = "§77. §f-";
			eight = "§78. §f-";
			nine = "§79. §f-";
			...
			four = "§74. " + nickname.get(3) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(3));
			five = "§75. " + nickname.get(4) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(4));
			six = "§76. " + nickname.get(5) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(5));
			seven = "§77. §f-";
			eight = "§78. §f-";
			nine = "§79. §f-";
			ten = "§710. §f-";
			...
			five = "§75. " + nickname.get(4) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(4));
			six = "§76. " + nickname.get(5) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(5));
			seven = "§77. " + nickname.get(6) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(6));
			eight = "§78. §f-";
			nine = "§79. §f-";
			ten = "§710. §f-";
			eleven = "§711. §f-";
			...
			six = "§76. " + nickname.get(5) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(5));
			seven = "§77. " + nickname.get(6) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(6));
			eight = "§78. " + nickname.get(7) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(7));
			nine = "§79. §f-";
			ten = "§710. §f-";
			eleven = "§711. §f-";
			twelve = "§712. §f-";
			...
			seven = "§77. " + nickname.get(6) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(6));
			eight = "§78. " + nickname.get(7) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(7));
			nine = "§79. " + nickname.get(8) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(8));
			ten = "§710. §f-";
			eleven = "§711. §f-";
			twelve = "§712. §f-";
			thirteen = "§713. §f-";
			...
			eight = "§78. " + nickname.get(7) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(7));
			nine = "§79. " + nickname.get(8) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(8));
			ten = "§710. " + nickname.get(9) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(9));
			eleven = "§711. §f-";
			twelve = "§712. §f-";
			thirteen = "§713. §f-";
			fourteen = "§714. §f-";
			...
			nine = "§79. " + nickname.get(8) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(8));
			ten = "§710. " + nickname.get(9) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(9));
			eleven = "§711. " + nickname.get(10) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(10));
			twelve = "§712. §f-";
			thirteen = "§713. §f-";
			fourteen = "§714. §f-";
			fifteen = "§715. §f-";
			...
			ten = "§710. " + nickname.get(9) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(9));
			eleven = "§711. " + nickname.get(10) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(10));
			twelve = "§712. " + nickname.get(11) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(11));
			thirteen = "§713. §f-";
			fourteen = "§714. §f-";
			fifteen = "§715. §f-";
			...
			eleven = "§711. " + nickname.get(10) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(10));
			twelve = "§712. " + nickname.get(11) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(11));
			thirteen = "§713. " + nickname.get(12) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(12));
			fourteen = "§714. §f-";
			fifteen = "§715. §f-";
			...
			twelve = "§712. " + nickname.get(11) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(11));
			thirteen = "§713. " + nickname.get(12) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(12));
			fourteen = "§714. " + nickname.get(13) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(13));
			fifteen = "§715. §f-";
			...
			thirteen = "§713. " + nickname.get(12) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(12));
			fourteen = "§714. " + nickname.get(13) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(13));
			fifteen = "§715. " + nickname.get(14) + " §f| §a" + NumberFormat.getInstance().format(quantity.get(14));
		}
		
		HologramAPI.criarHolograma(message, "§f§lTOP CHALLENGER §8- §4Extreme");
	...
	public void removeHologram(Location loc) {
		...
		HologramAPI.removerHolograma(message, "§f§lTOP CHALLENGER §8- §4Extreme");
