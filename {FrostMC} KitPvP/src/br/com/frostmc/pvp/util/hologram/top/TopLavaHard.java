...
public class TopLavaHard {
	...
	public void load() {
		try {
			...
			ResultSet resultSet = statement.executeQuery("SELECT * FROM `players_stats_pvp` ORDER BY `lava_hard` DESC;");
			int x = 0;
	...
	public void spawnHologram(Location loc) {
		...
		HologramAPI.criarHolograma(message, "§f§lTOP CHALLENGER §8- §cDíficil");
	...
	public void removeHologram(Location loc) {
		...
		HologramAPI.removerHolograma(message, "§f§lTOP CHALLENGER §8- §cDíficil");
