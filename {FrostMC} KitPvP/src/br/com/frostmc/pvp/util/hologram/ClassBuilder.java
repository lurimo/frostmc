package br.com.frostmc.pvp.util.hologram;
...
public abstract class ClassBuilder {
	...
	public static Object buildEntityHorse_1_7(Object world, Location loc, String name) throws Exception {
		...
		if (HologramAPI.is1_8()) {
			...
			NMSClass.Entity.getDeclaredMethod("setCustomNameVisible", boolean.class).invoke(horse_1_7,
					name != null && !name.isEmpty());
		} else {
			if (name != null) {
				NMSClass.EntityInsentient.getDeclaredMethod("setCustomName", String.class).invoke(horse_1_7, name);
			}
			NMSClass.EntityInsentient.getDeclaredMethod("setCustomNameVisible", boolean.class).invoke(horse_1_7,
					name != null && !name.isEmpty());
		}
		...
		NMSClass.DataWatcher.getDeclaredMethod("watch", new Class[] { int.class, Object.class })
				.invoke(horseDataWatcher, new Object[] { 12, -1700000 });
	...
	public static Object buildEntityHorse_1_8(Object world, Location loc, String name) throws Exception {
		...
		if (HologramAPI.is1_8()) {
			...
			NMSClass.EntityInsentient.getDeclaredMethod("setCustomNameVisible", boolean.class).invoke(horse_1_8,
					name != null && !name.isEmpty());
		}
	...
	public static Object buildEntityArmorStand(Object world, Location loc, String name) throws Exception {
		...
		NMSClass.Entity.getDeclaredMethod("setCustomNameVisible", boolean.class).invoke(armorStand,
				name != null && !name.isEmpty());
	...
	public static Object buildHorseSpawnPacket_1_7(Object horse, String name) throws Exception {
		...
		Object spawnPacketHorse_1_7 = NMSClass.PacketPlayOutSpawnEntityLiving.getConstructor(NMSClass.EntityLiving)
				.newInstance(horse);
		Object dataWatcher_1_7 = AccessUtil.setAccessible(NMSClass.PacketPlayOutSpawnEntityLiving.getDeclaredField("l"))
		...
		NMUClass.gnu_trove_map_hash_TIntObjectHashMap.getDeclaredMethod("put", int.class, Object.class).invoke(map, 12,
				NMSClass.WatchableObject.getConstructor(int.class, int.class, Object.class).newInstance(2, 12,
						-1700000));
	...
	public static Object buildHorseSpawnPacket_1_8(Object horse, String name) throws Exception {
		...
		Object dataWatcher_1_8 = AccessUtil.setAccessible(NMSClass.PacketPlayOutSpawnEntityLiving.getDeclaredField("l"))
				.get(spawnPacketHorse_1_8);
		Object map_1_8 = AccessUtil.setAccessible(NMSClass.DataWatcher.getDeclaredField("dataValues"))
				.get(dataWatcher_1_8);
		NMUClass.gnu_trove_map_hash_TIntObjectHashMap.getDeclaredMethod("put", int.class, Object.class).invoke(map_1_8,
				10, NMSClass.WatchableObject.getConstructor(int.class, int.class, Object.class).newInstance(0, 10,
						(byte) 1));

		List<Integer> toRemove = new ArrayList<>();

		for (int i = 0; i < 100; i++) {// 100 is a random value, we just want to get all values
			Object current = NMUClass.gnu_trove_map_hash_TIntObjectHashMap.getDeclaredMethod("get", int.class)
					.invoke(map_1_8, i);
			if (current == null) {
				continue;
			}
		...
		NMUClass.gnu_trove_map_hash_TIntObjectHashMap.getDeclaredMethod("put", int.class, Object.class).invoke(map_1_8,
				0, NMSClass.WatchableObject.getConstructor(int.class, int.class, Object.class).newInstance(0, 0,
						(byte) 32));
