...
public class TopLavaMedium {
	...
	public void load() {
		try {
			...
			ResultSet resultSet = statement.executeQuery("SELECT * FROM `players_stats_pvp` ORDER BY `lava_medium` DESC;");
			int x = 0;
	...
	public void spawnHologram(Location loc) {
		...
		HologramAPI.criarHolograma(message, "§f§lTOP CHALLENGER §8- §eMédio");
	...
	public void removeHologram(Location loc) {
		...
		HologramAPI.removerHolograma(message, "§f§lTOP CHALLENGER §8- §eMédio");
