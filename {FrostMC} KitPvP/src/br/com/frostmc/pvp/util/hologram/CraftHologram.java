	...
	protected void buildPackets(boolean rebuild) throws Exception {
		...
		if (HologramAPI.is1_8 && !HologramAPI.useProtocolSupport) {
			...
			this.dataWatcherArmorStand = AccessUtil
					.setAccessible(NMSClass.PacketPlayOutSpawnEntityLiving.getDeclaredField("l"))
		...
		AccessUtil.setAccessible(NMSClass.PacketPlayOutAttachEntity.getDeclaredField("a")).set(this.ridingAttachPacket,
				0);
		AccessUtil.setAccessible(NMSClass.PacketPlayOutAttachEntity.getDeclaredField("a")).set(this.ridingEjectPacket,
				0);
		...
		AccessUtil.setAccessible(NMSClass.PacketPlayOutAttachEntity.getDeclaredField("c")).set(this.ridingAttachPacket,
				this.getAttachedTo() != null ? this.getAttachedTo().getEntityId() : -1);
		AccessUtil.setAccessible(NMSClass.PacketPlayOutAttachEntity.getDeclaredField("c")).set(this.ridingEjectPacket,
				-1);
