	...
	public void sendFeastMessage(int tempo) {
		for (Player players : Bukkit.getOnlinePlayers()) {
			if (!WarpsAPI.isInWarp(players, Warps.ARENA))
				return;
			if (tempo > 60) {
				players.sendMessage("§8[§a§lFEAST§8] §fO Feast irá spawnar em §6" + tempo / 60 + " minutos§f. (§6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockX() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockY() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockZ() +  "§f) Digite /feast para apontar a bússola.");
			} else if (tempo == 60) {
				players.sendMessage("§8[§a§lFEAST§8] §fO Feast irá spawnar em §6" + tempo / 60 + " minuto§f. (§6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockX() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockY() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockZ() +  "§f) Digite /feast para apontar a bússola.");
			} else if (tempo < 60 && tempo > 1) {
				players.sendMessage("§8[§a§lFEAST§8] §fO Feast irá spawnar em §6" + tempo + " segundos§f. (§6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockX() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockY() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockZ() +  "§f) Digite /feast para apontar a bússola.");
			} else if (tempo == 1) {
				players.sendMessage("§8[§a§lFEAST§8] §fO Feast irá spawnar em §6" + tempo + " segundo§f. (§6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockX() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockY() + "§f, §6" + FrostPvP.getConfigManager().getLocationFromConfig("Feast.pos1").getBlockZ() +  "§f) Digite /feast para apontar a bússola.");
			} else if (tempo == 0) {
