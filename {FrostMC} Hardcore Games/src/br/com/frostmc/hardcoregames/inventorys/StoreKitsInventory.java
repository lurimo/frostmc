...
public static String titleStoreKits;
	...
	public static void abrirMenu(Player p) {
		...
		inv.setItem(4, new ItemBuilder().setMaterial(Material.NETHER_STAR).setNome("§9Informação:").setLore(Arrays.asList("", "§fEscolha uma habilidade para", "§fcomprar com suas fichas.", "", "§fOBS: §a§nO preço de todos os", "§a§nkits são 1 FICHA.", "", "§fFichas: §e" + gamer.getFichas())).finalizar());
